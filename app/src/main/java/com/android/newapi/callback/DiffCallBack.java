package com.android.newapi.callback;
...
public class DiffCallBack extends DiffUtil.Callback {
    ...
    public int getOldListSize() {
        return this.mOldDatas == null ? 0 : this.mOldDatas.size();
    }

    @Override
    public int getNewListSize() {
        return this.mNewDatas == null ? 0 : this.mNewDatas.size();
    }
    ...
    public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
        return this.mOldDatas.get(oldItemPosition).getName().equals(this.mNewDatas.get(newItemPosition).getName());
    }
